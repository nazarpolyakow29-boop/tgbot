...
async def successful_payment(
    ...
    if not os.path.exists(VIDEO_FILE):
        ...
        await message.answer(
            ...
            "Пожалуйста, обратитесь к администратору @yuzaye , ! Если вы оплатили только 1 раз то видео будет только на 1 просмотр, оплатите 2 раза чтоб получить видео с возможностью сохранить его"
        )
